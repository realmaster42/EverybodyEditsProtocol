...
|Id | Type | Event | Description |
|-- | --- | ---- | ----- | ----------- |
 |    1	| Boolean |  Allowed |  Value indicating whether spectating is allowed.|
...
| ---- | ----- | ----------- |
| UInt |  X |  The x coordinate of the block's position.|
| UInt |  Y |  The y coordinate of the block's position.|
| UInt |  Block Id |  The block id.|
| String |  Text |  The text.|
| UInt |  Sign Type |  The type of the sign.|
| UInt |  Player Id |  The id of the player which placed this block.|
...
| Id | Type | Event | Description |
| --- | ---- | ----- | ----------- |
     1	| Integer |  Layer |  The layer id.|
     2	| Integer |  X |  The x coordinate of the block's position.|
     3	| Integer |  Y |  The y coordinate of the block's position.|
     4	| Integer |  Block Id |  The block id.|
...
| --- | ---- | ----- | ----------- |
0 | String |  Text |  The text.|
2 | Integer |  Sign Type |  The sign type.|
...
|Id | Type | Event | Description |
--- | --- | ---- | ----- | ----------- |
 1	| String |  Edit Key |  The edit key.|
...
|Id | Type | Event | Description |
--- | --- | ---- | ----- | ----------- |
  1	| Boolean |  Allowed |  Value indicating whether the spectating should be allowed.|
...
|Id | Type | Event | Description |
--- | --- | ---- | ----- | ----------- |
  1	| Integer |  Curse Limit |  The curse limit.|
...
|Id | Type | Event | Description |
--- | --- | ---- | ----- | ----------- |
  1	| Boolean |  Hidden |  Value indicating whether the world should be hidden from the lobby and profile.|
...
|Id | Type | Event | Description |
--- | --- | ---- | ----- | ----------- |
  1	| Boolean |  Enabled |  Value indicating whether the lobby preview should be enabled.|
...
| Type | Event | Description |
| ---- | ----- | ----------- |
| String |  Description |  The world description.|
...
| Type | Event | Description |
| ---- | ----- | ----------- |
| Boolean |  Accessible |  Value indicating whether other players are allowed to join the world.|
